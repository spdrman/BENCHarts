 ...
 */
export const DEFAULT_FALLBACK_COLORS = CATEGORICAL;
 ...
 */
export const CHECKED_SURFACES = Object.freeze([
  '#ffffff', '#1a1a19', '#1a1a1a', '#11182A', '#070A0F',
]);

/** Separation floor, in CIE76 units, below which secondary encoding stops excusing it. */
export const DELTA_E_FLOOR = 6.0;
